...
class classTemplate:
    ...
    def createSource(self):
        ...
        cm += ('***********************************************************/\n')
        for func in self.__func_list:
            cm += self.__cTemp.generateFunctionComment2(self.__fileName+'_'+func+'('+'h'+self.__fileName+' t)','t - '+self.__fileName+'类指针','无',self.__fileName+'类功能函数')
